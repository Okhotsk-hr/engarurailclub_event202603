...
for ($i = 0; $i <= count($result_lines) - 1; $i++) {
    ...
    //内容データの確認
    // echo "    <script>
    //     alert('list_search.php');
    // </script>";
    // echo "    <script>
    //     alert('" .  $v_list[$result_lines[$i]][4] . "');
    // </script>";
    $_SESSION["v_cards"]  .= '
    <div class="card">
    <div style="font-size:5px">　</div>
            <!--<div class="v_name">' . $v_list[$result_lines[$i]][3] . ' </div>-->

                    <div class="titlebox">
            <div class="icon"><img src=' . $v_list[$result_lines[$i]][8] . ' alt=""></div>
              <table border="1" class="tables">
                <tr>
                    <th>
                        ' . $v_list[$result_lines[$i]][3] . '
                    </th>
                </tr>
            </table>
                        </div>
            ...
            <div class="img"><img src=' . $v_list[$result_lines[$i]][1] . ' alt="" class="mainimg"></div>
            <div style="font-size:5px">　</div>
            ...
            <!--<table border="1" class="tables">
                <tr>
                    <td>
                        ' . $v_list[$result_lines[$i]][4] . '
                    </td>
                    <td>
                        ' . $v_list[$result_lines[$i]][5] . '
                    </td>
                </tr>
            </table>-->
    </div>
